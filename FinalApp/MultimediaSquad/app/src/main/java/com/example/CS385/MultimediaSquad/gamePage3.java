...
public class gamePage3 extends AppCompatActivity {
        ...
        next.setOnClickListener(new View.OnClickListener(){ //button to proceed through dialogue
            public void onClick(View l){
                ...
                if(counter < dialogue.length){
                    ...
                    d.setDay(4); //sets day to 4 once dialogue is finished
                    Intent home = new Intent(gamePage3.this, house.class); //when dialogue is finished, button brings user to next page
                    startActivity(home);
                }
            }
    ...
    public void loadDialogue(){
        ...
        dialogue = res.getStringArray(R.array.page3); //loads dialogue from xml file to string array in java
    }
}
