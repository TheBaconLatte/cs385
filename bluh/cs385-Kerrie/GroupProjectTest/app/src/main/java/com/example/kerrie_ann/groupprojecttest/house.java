            ...
            stay.setOnClickListener(new View.OnClickListener() {
                public void onClick(View m) {
                   if (day == 2) {
                       ...
                       Toast.makeText(getApplicationContext(), "attendance = " + attendance + " Skip the last day and miss the test? I can't do that or I'll never get my reference!", Toast.LENGTH_LONG).show();
                    }
